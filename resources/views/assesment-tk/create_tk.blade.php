            ...
            <div class="card card-header-actions shadow justify-content-between">
                ...
                <div class="card-body">
                    <form method="POST" action="/post-tk">
                        ...
                        <div class="mb-3">
                            <label for="startDate">Nama Karyawan</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" name="nama_karyawan">
                        </div>
                        <div class="mb-3">
                            <label for="startDate">Jabatan</label>
